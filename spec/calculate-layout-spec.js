...
describe('MAPJS.calculateLayout', function () {
	...
	describe('when the theme is provided', function () {
		it('takes node spacing from the theme', function () {
			var contentAggregate = {
					id: 7,
			...
			result = MAPJS.calculateLayout(contentAggregate, dimensionProvider, theme);
			expect(result.nodes[7]).toEqual(jasmine.objectContaining({
				x: -20,
				y: -10
			}));
		...
		it('lays out children below root if direction is vertical', function () {
			var contentAggregate = {
					id: 7,
					title: '1', /*width 40, height: 20 */
					ideas: {
