...
describe('Top down layout', function () {
	...
	it('should set the width properties of the root node', function () {
		...
		expect(result.xOffset).toEqual(-25);
		expect(result.width).toEqual(50);
	});
	it('should arrange a single child layout directly below the root', function () {
		var node = {id: 1, width: 50, height: 10},
			childLayouts = { /* rank */ 4: { xOffset: -20, width: 40, nodes: { /* id */ 11: { id: 11, x: -20, width: 40, height: 10 } } } },
	...
	it('should rank-sort child layouts', function () {
		...
		var node = {id: 1, width: 50, height: 10},
			childLayouts = {
				/* rank */ 4: { xOffset: -20, width: 40, nodes: { /* id */ 14: { id: 14, x: -20, width: 40, height: 10 } } },
				/* rank */ '-1': { xOffset: -20, width: 40, nodes: { /* id */ 12: { id: 12, x: -20, width: 40, height: 10 } } },
				/* rank */ 1: { xOffset: -20, width: 40, nodes: { /* id */ 13: { id: 13, x: -20, width: 40, height: 10 } } },
				/* rank */ '-4': { xOffset: -20, width: 40, nodes: { /* id */ 11: { id: 11, x: -20, width: 40, height: 10 } } }
			},
